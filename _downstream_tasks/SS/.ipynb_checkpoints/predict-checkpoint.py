...
def getParam():
    ...
    parser.add_argument('--rootdir', default='/userhome/zhouyq/gaozhq/zhyk/projects/RNA-MSM-Infer/_downstream_tasks/SS',
                        type=str)
    parser.add_argument('--featdir', default='/userhome/zhouyq/gaozhq/zhyk/projects/RNA-MSM-Infer/results',
                        type=str)
