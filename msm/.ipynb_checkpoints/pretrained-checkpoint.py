...
def load_model_and_alphabet_core(model_data, regression_data=None):
    ...
    alphabet = msm.Alphabet.from_architecture(model_data["args"].arch)
    ...
    if model_data["args"].arch == "roberta_large":
        ...
        model_type = msm.ProteinBertModel
...
def esm_msa1_t12_100M_UR50S():
    warnings.warn(
        ...
        "please use ESM-MSA-1b: msm.pretrained.esm_msa1b_t12_100M_UR50S()",
    )
