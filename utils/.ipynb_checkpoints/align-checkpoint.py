...
class MSA:
    ...
    def hhfilter(
        ...
        with tempfile.TemporaryDirectory(dir="/userhome/zhouyq/gaozhq/zhyk/projects/RNA-MSM-Infer") as tempdirname:    # dir="/userhome/zhouyq/gaozhq/zhyk/projects/emb-transformer/data"
